...
// Efek untuk mendeteksi scroll
  ...
  return (
    ...
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%]'>
     ...
     <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 transition-all duration-300 ease-in-out
                ${isScrolled ? "bg-white/50 backdrop-blur-lg shadow-sm" : ""}`}>

        <a href="#top">
            {/* <Image src={assets.logo} alt="" className='w-28 cursor-pointer mr-14'/> */}
            <h1 className='text-2xl font-bold'>Noverio<span className='text-red-500'>.</span></h1>
        </a>
